...
locals {
  # Describes the two application environments without creating resources by
  # itself. Resources opt into this model explicitly through for_each, keeping
  # the environment names, identities, protection, and secret versions aligned.
  environments = {
    development = {
